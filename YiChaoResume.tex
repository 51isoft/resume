...
%-----------------------------------------------------------
%Custom commands
\newcommand{\resitem}[1]{\item #1 \vspace{-2.8pt}}
...
\begin{document}
    ...
    \item
        ...
        \begin{itemize}
            \resitem{北京师范大学ACM/ICPC代表队学生教练，保送进入研究生阶段学习}
            \resitem{负责北京师范大学程序设计竞赛的组织和出题工作}
            \resitem{负责维护学院内多台Linux服务器}
        \end{itemize}
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \resheading{技能}
    ...
    \begin{itemize} \itemsep -0.2em
        \resitem {{\bf 了解技术：} C/C++, JS, PHP, Linux, Ruby on Rails}
        \resitem {{\bf 兴趣方向：} 算法、后端开发、网站开发}
        \resitem {较强的学习能力，对新技术有较高的热情，勇于尝试新鲜事物。}
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \resheading{实习经历}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{itemize}
        \item
            \ressubheading{软件开发工程师}{Ruby, JS}{Web-audience team, Hulu LLC., Beijing}{2013.6 至今}
            \begin{itemize}
                \resitem{参与Hulu网站的前后端开发，工作包括功能开发、性能调优等}
                \resitem{实习期间的项目包括\it {Recommendation Hub},  \it {CodeReview Stats site} 等}
            \end{itemize}
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \resheading{所获荣誉}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{itemize} \itemsep -0.2em
    	\resitem {2013年Google优秀奖学金}
        \resitem {多次ACM-ICPC亚洲区域赛金奖}
        \resitem {首届``中科杯''全国软件设计大赛三等奖}
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \resheading{项目经历}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
