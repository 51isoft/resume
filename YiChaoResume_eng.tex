...
\begin{document}
    ...
    \begin{itemize}
        \item
            \ressubheading{SDE Intern}{Ruby, JS}{Web-audience team, Hulu Beijing Inc.}{2013.6 - now}
            \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Mutiple Gold medals in ACM-ICPC International Collegiate Programming Contest Regional Contest
    \end{itemize}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \resheading{Projects}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
